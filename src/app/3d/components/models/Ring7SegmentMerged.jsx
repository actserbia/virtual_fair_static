...
export function Ring7Instances({ children, ...props }) {
  ...
  const instances = useMemo(
    () => ({
      ...
      RINGMODLOW1: nodes.RING_7_MOD_LOW_2,
      RINGMODLOW2: nodes.RING_7_MOD_LOW_3,
      RINGMODLOW3: nodes.RING_7_MOD_LOW_4,
      RINGMODLOW4: nodes.RING_7_MOD_LOW_5,
      RINGMODLOW5: nodes.RING_7_MOD_LOW_6,
    }),
    [nodes]
  );
  return (
...
export function Ring7SegmentLowInstance(props) {
